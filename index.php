		...
		<div class="tp-banner">
			<ul>
				...
				<li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
					<img alt="" src="assets/base/img/layout/slides/slide-home-guarita.jpg" 
					...
					<div class="caption customin customout tp-resizeme" 
						...
						CONHEÇA O MODELO DE INVESTIMENTO À PREÇO DE CUSTO</h3>
					</div>
					<div class="caption lft tp-resizeme" data-x="center" data-y="center" data-voffset="110" data-speed="900" data-start="2000" data-easing="easeOutExpo">
						<a href="#" class="c-action-btn btn btn-lg c-btn-square c-theme-btn c-btn-bold c-btn-uppercase">conheça mais</a>
					</div>
				</li>
					...
					<div class="col-md-7">
						<div class="c-content-feature-5">
							<div class="c-content-title-1">
								<h3 class="c-left c-font-bold">LANÇAMENTO <i class="fa fa-video-camera"></i> </h3>
							</div>
							<div class="embed-responsive embed-responsive-16by9">								<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/en4un1xrtFU" frameborder="0" allowfullscreen>								</iframe>							</div>
						</div>
					</div>										
					<div class="col-md-5">
							...
							<div class="panel-group" id="accordion" role="tablist">
								...
								<div class="panel">
									...
									<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
										<div class="panel-body c-font-18">
											 Na construção dos empreendimentos, nas práticas de gestão, nas relações comerciais, na comunicação. A QUALIDADE está presente em todos os processos da empresa										</div>
									</div>
								</div>
								...
								<div class="panel">
									...
									<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
										<div class="panel-body c-font-18">
											 Uma prática do dia-a-dia. Nas relações com investidores, fornecedores e parceiros, bem como em relação à comunidade e ao meio ambiente.
										</div>
									</div>
								</div>								
								<div class="panel">
									<div class="panel-heading" role="tab" id="headingTwo">
										<h4 class="panel-title">
										<a class="collapsed c-font-uppercase c-font-bold c-font-19" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
										LEALDADE</a>
										</h4>
									</div>									
									<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
										<div class="panel-body c-font-18">
											 Presente em todas as relações, seja com o agentes do mercado ou com os clientes internos e externos.										</div>
									</div>
								</div>																								<div class="panel">									<div class="panel-heading" role="tab" id="headingThree">										<h4 class="panel-title">										<a class="collapsed c-font-uppercase c-font-bold c-font-19" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">										DEDICAÇÃO</a>										</h4>									</div>									<div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">										<div class="panel-body c-font-18">											 A empresa dedica-se aos empreendimentos e aos colaboradores que os fazem acontecer.  Nossa DEDICAÇÃO reforça os pilares da QUALIDADE, RESPONSABILIDADE e LEALDADE.										</div>									</div>								</div>								
	...
	<div class="c-content-box c-size-lg c-bg-parallax" style="background-image: url(assets/base/img/content/backgrounds/fundo-cimento-azul.jpg)">
		<div class="container">
			<div class="c-content-bar-1 c-opt-1">
				...
				<a href="contato.php" class="btn btn-md c-btn-square c-theme-btn c-btn-uppercase c-btn-Sbold">FALE AGORA COM A GENTE!</a>
			</div>
		</div>
	</div>
