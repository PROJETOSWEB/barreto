        ...
        <div class="col-lg-8">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php foreach ($updateEvento as $row): ?>
                        <?php echo form_open('eventos/evento/update/' . $row['evento_id'], array('enctype' => 'multipart/form-data')); ?>


                        <div class="form-group">
                            <label for="exampleInputEmail1">NOME DO EVENTO</label>
                            <input name="nome" value="<?php echo $row['nome']; ?>" id="nome" tooltip="Título do seu artigo, EVITE TÍTULOS LONGOS" type="text" class="form-control" data-placement="top">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">DIA EVENTO</label>
                            <input name="dia" value="<?php echo $row['data_evento']; ?>" tooltip="Título do seu artigo, EVITE TÍTULOS LONGOS" type="text" class="form-control" data-placement="top">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">HORARIO(S) DO EVENTO</label>
                            <input name="horario" value="<?php echo $row['horario_evento']; ?>" id="nome" tooltip="Título do seu artigo, EVITE TÍTULOS LONGOS" type="text" class="form-control" data-placement="top">
                        </div>
