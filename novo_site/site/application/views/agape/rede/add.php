        ...
        <div class="col-lg-8">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open('redes/rede/create', array('enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input name="responsavel" id="nome" tooltip="Título do seu artigo, EVITE TÍTULOS LONGOS" type="text" class="form-control" data-placement="top">
                    </div>
