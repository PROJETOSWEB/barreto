        ...
        <div class="col-lg-8">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                     ...
                     <?php foreach ($updateBanner as $row):

                     echo form_open('banner/banner/update/'.$row['banner_id'], array('enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="row ">
                            <div class="form-group col-sm-12">
                                <label class="col-sm-3 col-sm-3">Usar imagens com tam. 1200x650px ou maiores</label>
