        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                    <img alt="" src="<?php echo base_url(); ?>template/assets/base/img/layout/slides/frente-final-lumier.jpg" 
                ...
                <!--fim --><!--BEGIN: SLIDE #2 -->
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                    <img alt="" src="<?php echo base_url(); ?>template/assets/base/img/layout/slides/pessoas2.jpg" 
                         data-bgposition="center center" 
                         data-bgfit="cover" 
                         data-bgrepeat="no-repeat">
                    <div class="caption customin customout tp-resizeme" 
                         ...
                         data-endspeed="600">
                        <h3 class="c-block-bordered c-font-35 c-font-bold c-font-center c-font-uppercase c-font-white c-block">
                            <br/><br/>Investimento diferenciado para <h3 style="margin-bottom: -18px;">pessoas diferenciadas</h3>
                    </div>
                    <div class="caption lft tp-resizeme" data-x="center" data-y="center" data-voffset="110" data-speed="900" data-start="2000" data-easing="easeOutExpo">
                        <a href="preco_custo.php" class="c-action-btn btn btn-lg c-btn-square c-theme-btn c-btn-bold c-btn-uppercase">conheça mais</a>
                    </div>
                        ...
                        <div class="panel-group" id="accordion" role="tablist">
                            ...
                            <div class="panel">
                                ...
                                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body c-font-18">
                                        Presente em todas as relações da empresa: com os agentes do mercado, com os investidores e com os nossos colaboradores, a TRANSPARÊNCIA é uma das nossas diretrizes.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel">
                                ...
                                <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                    <div class="panel-body c-font-18">
                                        Nas relações com investidores,  visando um maior retorno financeiro aos seus investimentos,  como também nas relações com os fornecedores e parceiros e com a comunidade e o meio ambiente.
                                    </div>
                                </div>
                            </div>
...
<div class="c-content-box c-size-lg c-bg-parallax" style="background-image: url(<?php echo base_url(); ?>template/assets/base/img/content/backgrounds/fundo-cimento-azul.jpg)">
    <div class="container">
        <div class="c-content-bar-1 c-opt-1">
            ...
            <a href="contato.php" class="btn btn-md c-btn-square c-theme-btn c-btn-uppercase c-btn-Sbold">ENTRE EM CONTATO!</a>
        </div>
    </div>
</div>
