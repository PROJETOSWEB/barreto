...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>img/ico-sky.png">
...
<body class="login-body">
    <div class="container">
        ...
        <h2 class="form-signin-heading" style="background-image: url(<?php echo base_url(); ?>template/img/bg-topo.png);">
            <img style="margin-left: 10px; margin-bottom: -20px;" src="<?php echo base_url(); ?>template/img/logo-03.png" height="75" width="300" alt="" />
        </h2>
